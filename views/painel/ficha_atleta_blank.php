...
<table width="95%" border="0" cellspacing="0" cellpadding="10" style="margin-top: -25px;">
  <tbody>
    ...
    <tr>
      <td colspan="6" class="borda-linha"><b>Campeonato:</b> 
    ...
    <tr>
      <td class="borda-linha"><b>Clube Filiado:</b> </td>

      <td colspan="5" class="borda-linha">&nbsp;</td>
    </tr>
    
    <tr>
	 <td class="borda-linha" colspan="4"><b>Nome do Atleta:</b>  </td>
   <td colspan="2" class="borda-linha"><b>Contato:</b>  </td>
    
    </tr>
    
    <tr>
      <td colspan="2" class="borda-linha"><b>Data de Nascimento:</b></td>
      <td colspan="2" class="borda-linha"><b>Natural de:</b>  </td>
      <td colspan="2" class="borda-linha"><b>Estado:</b></td>
    </tr>
    
    <tr>
      <td colspan="2" class="borda-linha"><b>RG:</b> </td>
      <td colspan="4" class="borda-linha"><b>CPF:</b> </td>
    </tr>
    
    <tr>
      <td colspan="6" class="borda-linha"><b>Endereço:</b>  </td>
    </tr>
    <tr>
      <td colspan="6" class="borda-linha"> <b> Bairro: </b> </td>
    </tr>

  <tr>
      <td colspan="6" class="borda-linha"><b> Cep: </b> </td>
    </tr>
    


    <tr>
      <td class="borda-linha" colspan="6"><b>Nome do Pai:</b> </td>
    </tr>
    
    <tr>
      <td class="borda-linha" colspan="6"><b>Nome da Mãe:</b></td>
    </tr>
    
    <tr>
      <td colspan="3" class="borda-linha"><b>Vem solicitar sua inscrição para temporada de </b> </td>
    ...
    <tr>
      ...
      <td colspan="4" class="assinatura-atleta"  style="visibility:<?php verifica_idade($inscricao["nascimento"],$inscricao["atleta_id"]);?>">
        ...
        <span  style="visibility:<?php verifica_idade($inscricao["nascimento"],$inscricao["atleta_id"]);?>"> 
          ...
          <b>Assinatura do Responsável</b></td>
