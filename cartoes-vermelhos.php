    ...
    <div class="card card--has-table" style="height:500px;overflow:auto">
              ...
              <table class="table table-hover table-standings table-standings--full table-standings--full-soccer">
                ...
                <tbody>
                  ...
                  <?php foreach($ocorrencias as $ocorrencia){?>
                    ...
                    <?php if($ocorrencia["ref"]=="cartao_vermelho"){?>
          ...
          <div class="sidebar sidebar--shop col-md-3 col-md-pull-9">
           ...
           <div class="form-group">
                        ...
                        <select name="review-stars" id="review-stars" class="form-control" onchange="window.location='?camp=<?php echo $campeonato_id;?>&clube='+this.value">
                 ...
                 <ul class="widget__list">
                  ...
                  <li><a href="cartoes-vermelhos?camp=<?php echo $campeonato_id;?>"> <font color='#c01818'> Cartões Vermelhos </font> </a></li>
