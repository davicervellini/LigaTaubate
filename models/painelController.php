        ...
        else
        {
            ...
            {   
                ...
                if($_POST["atleta_id"]==0)
                {
                    ...
                    if(!$atleta_id)
                    {
                        $_SESSION["msg"] = "Limite de inscrições para atletas atingido!";
        ...
        if(isset($_POST["checked"]))
         {
            ...
            foreach($_POST["checked"] as $cx)
            {
                ...
                $sql .= " (inscricoes.campeonato_id = '".$explode[1]."' AND atletas.clube_id = '".$explode[0]."' AND atletas.atleta_id = '".$explode[2]."') OR";
