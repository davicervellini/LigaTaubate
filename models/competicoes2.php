    ...
    <nav class="content-filter">
      ...
      <div class="container">
        ...
        <ul class="content-filter__list">
          ...
          <?php $temporada = (isset($_GET["temporada"]) && $_GET["temporada"] != "") ? $_GET["temporada"] : date('Y'); ?>
          ...
          <?php foreach ($camp->getAll('all', $temporada) as $campeonato) { ?>
            ...
            <li class="<?php if ($campeonato["campeonato_id"] == $campeonato_id) {
                        ...
                        } ?>"><a href="?camp=<?php echo $campeonato["campeonato_id"]; ?>&temporada=<?php echo $temporada; ?>" class="content-filter__link"><small><?php echo $campeonato["descricao"]; ?></small><?php echo $campeonato["nome"]; ?></a></li>
                          ...
                          <td style="text-align: right; width: 5%; vertical-align: middle;">
                            ...
                            <figure>
                              ...
                              <?php if ($j["escudo_clube_1"] != "") { ?>
                                ...
                                <img src="https://www.ligataubate.com.br/cms/assets/images/escudos/<?php echo $j["escudo_clube_1"]; ?>" />
                          ...
                          <td style="text-align: right; width: 5%; vertical-align: middle;">
                            ...
                            <figure>
                              ...
                              <?php if ($j["escudo_clube_2"] != "") { ?>
                                ...
                                <img src="https://www.ligataubate.com.br/cms/assets/images/escudos/<?php echo $j["escudo_clube_2"]; ?>" />
            ...
            <aside class="widget card widget--sidebar widget_categories">
              ...
              <div class="widget__content card__content">
                ...
                <div class="form-group">
                  ...
                  <label class="control-label" for="review-stars">Filtar por Mandatos</label>
                  ...
                  <select name="review-stars" id="review-stars" class="form-control" style="text-transform: uppercase; color:#000000; font-weight: bold;" onchange="window.location='?temporada='+this.value">
                    <option value=""> </option>
                    <option value="2020-2022" <?php echo ($temporada == '2020-2022') ? 'selected' : ''; ?>> 2020-2022 </option>
                    <option value="2017-2019" <?php echo ($temporada == '2017-2019') ? 'selected' : ''; ?>> 2017-2019 </option>
                    ...
                    <?php /* <option value="2016" <?php echo ($temporada=='2016')? 'selected' : '';?> > 2016 </option> */ ?>
                  </select>
                </div>
                ...
                <div class="form-group">
                  ...
                  <select name="review-stars" id="review-stars" class="form-control" style="text-transform: uppercase; color:#000000; font-weight: bold;" onchange="window.location='?camp=<?php echo $campeonato_id; ?>&temporada=<?php echo $temporada; ?>&grupo=<?php echo $grupo; ?>&rodada='+this.value+'<?php if ($clube) {
                    ...
                    <?php foreach ($camp->getRodadasByCampeonatoId($campeonato_id) as $r) { ?>
